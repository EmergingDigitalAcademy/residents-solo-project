...
// test
router.put('/:tasks_id/residents/:resident_id', rejectUnauthenticated, async (req, res) => {
    console.log('/tasks PUT route')
    // console.log('req params id log', req.params.id);
    console.log('is authenticated?', req.isAuthenticated);
    console.log('user', req.user);
    ...
    try{
        ...
        SET "assistance_id" = $4, "date_time_completed" = NOW(), "user_id" = $3
        WHERE "resident_id" = $1 AND "tasks_id" = $2;
          `, [req.params.resident_id, req.params.tasks_id, req.user.id, req.body.assistance_id]
        )
